...
- (void)updateConstraints
{
    if (!self.didSetupConstraints) {
        ...
        [self.movie_tags autoPinEdgeToSuperviewEdge:ALEdgeLeading withInset:10];
        [self.movie_tags autoPinEdgeToSuperviewEdge:ALEdgeTrailing withInset:10];
        ...
        [self.movie_message autoPinEdgeToSuperviewEdge:ALEdgeTrailing withInset:10];
        ...
        [self.movie_description autoPinEdgeToSuperviewEdge:ALEdgeLeading withInset:10];
        [self.movie_description autoPinEdgeToSuperviewEdge:ALEdgeTrailing withInset:10];
        [self.movie_description autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.movie_message withOffset:10];
        [self.movie_description autoPinEdgeToSuperviewEdge: ALEdgeBottom withInset:10];
      
//        //影片放映时间
//        [NSLayoutConstraint autoSetPriority:UILayoutPriorityRequired forConstraints:^{
//            [self.time_table autoSetContentCompressionResistancePriorityForAxis:ALAxisVertical];
//        }];
//        [self.time_table autoPinEdgeToSuperviewEdge:ALEdgeLeading withInset:10];
//        [self.time_table autoPinEdgeToSuperviewEdge:ALEdgeTrailing withInset:10];
